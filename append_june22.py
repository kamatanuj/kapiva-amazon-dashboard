...
# Add CSS for new day
css_class = 'day-jun22'
css_entry = '        .day-jun22 { background: linear-gradient(135deg, #14b8a6 0%, #0d9488 100%); }\n'
if '.day-jun22' not in html:
    html = html.replace('.day-jun4 {', css_entry + '        .day-jun4 {')

# Remove existing latest highlight rows from comparison table body
for d in ['June 21, 2026', 'June 20, 2026', 'June 19, 2026']:
    html = re.sub(
...
new_card = f'''        <!-- Day: {today_display} (Latest) -->
        <div class="day-card">
            <div class="day-header day-jun22">
